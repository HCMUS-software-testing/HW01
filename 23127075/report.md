...
![alt text](req1-images/req1-linkedin-posting-01.png)
...
![alt text](req1-images/req1-linkedin-posting-02.png)
...
![alt text](req1-images/req1-linkedin-posting-03.png)
...
![alt text](req1-images/req1-linkedin-posting-04.png)
...
![alt text](req1-images/req1-linkedin-posting-05.png)
...
![alt text](req1-images/req1-linkedin-posting-06.png)
...
![alt text](req1-images/req1-linkedin-posting-07.png)
...
![alt text](req1-images/req1-linkedin-posting-08.png)
...
![alt text](req1-images/req1-linkedin-posting-09.png)
...
![Evidence](./req3-images/image.png)
...
AI was useful for fast drafting, but it was not reliable without checking. In Requirement 1, AI sometimes treated weak automation context as direct AI/LLM skill evidence, and it summarized job descriptions too generally. Some postings needed manual correction because AI missed details such as exact dates, salary, platform, and whether AI was truly required or only related to the company/product context. In Requirement 2, AI was more risky: it mixed up vulnerability identities, overstated severity, and described impacts such as full system takeover or guaranteed RCE when the source only supported conditional impact. This shows hallucination happens most when AI tries to sound complete from partial security knowledge. In Requirement 3, AI generated normal functional test cases but missed physical-product edge cases, such as default power-on speed, finger-safety grille check, and printed-label legibility. It failed because it reasoned from common software templates, not from real observation of the fan. The main lesson is to use AI as a drafting and brainstorming assistant, not as final authority. Good collaboration means giving narrow prompts, checking every claim against sources, testing the real device, and adding human judgment for safety, usability, and evidence. AI speeds work, but QA still needs verification, skepticism, and accountable human decisions.
...
- [x] Device photo with student-ID in same frame
- [x] Execution videos contain your own voice narration
- [x] All 10 job posting screenshots show your logged-in account/display name
- [x] Prompt log `.md` with timestamps for every AI prompt
...
- When AI should be used for this HW:
  - Research for information but need validation.
...
# AI-05 — AI Privacy & Responsible Use Checklist Template
...
### Data Handling
- [x] I did not upload sensitive personal data beyond what is required for the assignment
- [x] I masked device serial number middle 4 characters
- [x] I reviewed AI outputs for fabricated or unsafe instructions

### Academic Integrity
- [x] I did not submit AI output without verification
- [x] I included full prompt log with timestamps
- [x] I included AI Audit Report entries for AI-generated artifacts
- [x] I clearly marked which sections were AI-assisted vs written by me

### Anti-Cheat Compliance
- [x] Device photo includes my student ID in same frame
- [x] Test execution videos contain my own voice narration
- [x] Job posting screenshots show my account/display name
- [x] Evidence artifacts are authentic and reproducible

### Quality Controls
- [x] I validated AI-generated test cases against ISTQB/course materials
- [x] I identified and documented AI mistakes/bias/hallucination
- [x] I added student-generated edge cases AI missed

## Acknowledgement
I confirm this checklist is accurate and complete.
